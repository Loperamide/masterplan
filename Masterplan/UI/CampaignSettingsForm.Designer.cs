namespace Masterplan.UI
{
	partial class CampaignSettingsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.HPLbl.Text = Session.I18N.HPPercent + ":";
			// 
			// HPBox
			// 
			...
			this.AttackLbl.Text = Session.I18N.AttackBonus + ":";
			// 
			// ACBox
			// 
			...
			this.ACLbl.Text = Session.I18N.AC + ":";
			// 
			// InfoLbl
			// 
			...
			this.InfoLbl.Text = Session.I18N.LabelSettingsApply + ".";
			// 
			// DefenceBox
			// 
			...
			this.DefenceLbl.Text = Session.I18N.OtherDefences + ":";
			// 
			// XPBox
			// 
			...
			this.XPLbl.Text = Session.I18N.XPPointsPercent + ":";
			// 
			// DamageBox
			// 
			...
			this.dmgMultLbl.Text = Session.I18N.DamageMultPercent + ":";
			// 
